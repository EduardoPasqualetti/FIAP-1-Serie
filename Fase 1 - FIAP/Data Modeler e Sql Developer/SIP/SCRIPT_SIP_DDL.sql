...
ALTER TABLE t_sip_departamento ADD CONSTRAINT pk_t_sip_departamento PRIMARY KEY ( cd_departamento );

ALTER TABLE t_sip_departamento ADD CONSTRAINT un_sip_depto_nome UNIQUE ( nm_departamento );

ALTER TABLE t_sip_departamento ADD CONSTRAINT un_sip_depto_sigla UNIQUE ( sg_departamento );
...
ALTER TABLE t_sip_implantacao ADD CONSTRAINT ck_sit_implant_data CHECK ( dt_saida > dt_entrada );

ALTER TABLE t_sip_implantacao ADD CONSTRAINT pk_t_sit_implantacao PRIMARY KEY ( cd_implantacao,
                                                                                cd_projeto );
...
ALTER TABLE t_sip_projeto ADD CONSTRAINT ck_sit_projeto_data CHECK ( dt_termino > dt_inicio );
...
ALTER TABLE t_sip_funcionario
    ADD CONSTRAINT fk_sip_func_depto FOREIGN KEY ( cd_departamento )
